...
class ExplanationRequest(BaseModel):
    """Request schema for physics explanation endpoint."""
    
    question: str = Field(..., min_length=5, max_length=1000, description="Physics question or concept")
...
class ImageAnalysisRequest(BaseModel):
    ...
    class Config:
        ...
        json_schema_extra = {
            "example": {
                "question": "Explain the physics concepts shown in this diagram",
                "context": "This is from Chapter 5 on electromagnetism"
            }
        }
...
class BulkExplanationRequest(BaseModel):
    ...
    questions: list[str] = Field(..., max_items=10, description="List of questions")
