"""
API routes for Physics AI Explainer.
...
router = APIRouter(tags=["Physics Explanations"])


@router.post(
    "/explain",
    response_model=dict,
    summary="Generate Physics Explanation",
    description="Generate a comprehensive physics explanation for a given concept or question"
)
async def explain_concept(request: ExplanationRequest) -> dict:
    """
    Generate a physics explanation.
...
@router.post(
    ...
    description="Generate explanations for multiple physics concepts"
)
async def explain_multiple(
    questions: List[str] = Query(..., description="List of physics questions"),
    ...
    Args:
        questions: List of physics questions
        difficulty: Difficulty level for all explanations
...
@router.post(
    "/analyze-image",
    summary="Analyze Physics Diagram",
    description="Analyze a physics diagram or image with a specific question"
)
...
async def list_endpoints() -> dict:
    ...
    return {
        "status": "success",
        "endpoints": {
            "POST /explain": "Generate single physics explanation",
            "POST /explain/bulk": "Generate multiple explanations",
            "POST /analyze-image": "Analyze physics diagram/image",
